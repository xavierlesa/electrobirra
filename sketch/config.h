...
#define BUTTONS_ANALOG          false   // Por defecto usa el key analogo
//#define BUTTONS_DIGITAL         true    // Por defecto usa el key analogo
...
#define BUTTON_DELAY            30      // ms delay
...
#define SENSORS_BY_ADDRESS      false
...
//#define PID_KP                  2       // PID kp
//#define PID_KI                  5       // PID ki
//#define PID_KD                  1       // PID kd

// VERSION
#if BUTTONS_ANALOG == true
#define EBX_VERSION             "v1.0r201709A"
#else
#define EBX_VERSION             "v1.0r201709D"
#endif
